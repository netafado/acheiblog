...
var index = require('./index-f78c2c52.js');
var Url = require('url');
            ...
            return index.__awaiter(this, void 0, void 0, function () {
                ...
                return index.__generator(this, function (_e) {
                    switch (_e.label) {
                        ...
                        case 4: return [4 /*yield*/, _b.apply(void 0, [index.__assign.apply(void 0, _c.concat([(_d.request = _e.sent(), _d)]))])];
                        case 5:
                            output = _e.sent();
...
function httpRequest(options) {
    return new Promise(function (resolve, reject) {
        var req = http.request(index.__assign({ method: "GET" }, options));
...
var getMetadataToken = function (options) { return index.__awaiter(void 0, void 0, void 0, function () {
    return index.__generator(this, function (_a) {
        return [2 /*return*/, httpRequest(index.__assign(index.__assign({}, options), { host: IMDS_IP, path: IMDS_TOKEN_PATH, method: "PUT", headers: {
...
var getProfile = function (options) { return index.__awaiter(void 0, void 0, void 0, function () { return index.__generator(this, function (_a) {
    switch (_a.label) {
        case 0: return [4 /*yield*/, httpRequest(index.__assign(index.__assign({}, options), { host: IMDS_IP, path: IMDS_PATH }))];
...
var getCredentialsFromProfile = function (profile, options) { return index.__awaiter(void 0, void 0, void 0, function () {
    ...
    return index.__generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _b = (_a = JSON).parse;
                return [4 /*yield*/, httpRequest(index.__assign(index.__assign({}, options), { host: IMDS_IP, path: IMDS_PATH + profile }))];
            case 1:
            ...
            switch (_f.label) {
                case 0:
                    ...
                    sourceCreds = source_profile
                        ? resolveProfileData(source_profile, profiles, options, index.__assign(index.__assign({}, visitedProfiles), (_e = {}, _e[source_profile] = true, _e)))
 ...
 * @internal
 */
var ClientDefaultValues$2 = index.__assign(index.__assign({}, ClientSharedValues$2), { runtime: "node", base64Decoder: fromBase64, base64Encoder: toBase64, bodyLengthChecker: calculateBodyLength, defaultUserAgentProvider: defaultUserAgent({
        serviceId: ClientSharedValues$2.serviceId,
        clientVersion: packageInfo.version,
    }), maxAttempts: loadConfig(NODE_MAX_ATTEMPT_CONFIG_OPTIONS), region: loadConfig(NODE_REGION_CONFIG_OPTIONS, NODE_REGION_CONFIG_FILE_OPTIONS), requestHandler: new NodeHttpHandler(), retryModeProvider: loadConfig(NODE_RETRY_MODE_CONFIG_OPTIONS), sha256: Hash.bind(null, "sha256"), streamCollector: streamCollector, utf8Decoder: fromUtf8, utf8Encoder: toUtf8 });
...
var SSOClient = /** @class */ (function (_super) {
    ...
    function SSOClient(configuration) {
        var _this = this;
        var _config_0 = index.__assign(index.__assign({}, ClientDefaultValues$2), configuration);
...
var resolveSSOCredentials = function (profileName, profiles, options) { return index.__awaiter(void 0, void 0, void 0, function () {
...
var defaultProvider = function (init) {
    if (init === void 0) { init = {}; }
    var options = index.__assign({ profile: process.env[ENV_PROFILE$1] }, init);
 ...
 * @internal
 */
var ClientDefaultValues$1 = index.__assign(index.__assign({}, ClientSharedValues$1), { runtime: "node", base64Decoder: fromBase64, base64Encoder: toBase64, bodyLengthChecker: calculateBodyLength, credentialDefaultProvider: decorateDefaultCredentialProvider$1(defaultProvider), defaultUserAgentProvider: defaultUserAgent({
...
var STSClient = /** @class */ (function (_super) {
    ...
    function STSClient(configuration) {
        var _this = this;
        var _config_0 = index.__assign(index.__assign({}, ClientDefaultValues$1), configuration);
        var _config_1 = resolveRegionConfig(_config_0);
        var _config_2 = resolveEndpointsConfig(_config_1);
        var _config_3 = resolveRetryConfig(_config_2);
        var _config_4 = resolveHostHeaderConfig(_config_3);
...
const ClientDefaultValues = {
    ...
    retryModeProvider: loadConfig(NODE_RETRY_MODE_CONFIG_OPTIONS),
